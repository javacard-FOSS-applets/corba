...
/**
 * This class provides an implementation of ${interface.simplName}POA servant corba object using a distant 
 * applet in card terminal.
 * @author CorbaCard generator
 */
public class ${interface.simpleName}Impl extends ${interface.simplName}POA{
	//  This applet is designed to respond to the following
	//  class of instructions.
	final static byte ${interface.simpleName}Applet_CLA = (byte)${interfaceView.CLA};
	
	//  Instruction set for ${interface.simpleName}Applet
	<#assign seq = ["winter", "spring", "summer", "autumn"]>
	<#list seq as x>
  	final static byte ${method} = (byte)${method.address};
	</#list>
